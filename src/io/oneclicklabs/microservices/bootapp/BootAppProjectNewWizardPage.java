 ...
 *
 */
public class BootAppProjectNewWizardPage extends WizardPage{
	
	// initial value stores
    private String initialProjectFieldValue= BootAppProjectNewWizard.PROJECT_NAME;
     ...
     */
    public BootAppProjectNewWizardPage(String pageName) {
    	super(pageName);
    ...
    private String getProjectNameFieldValue() {
        if (projectNameField == null) {
			return BootAppProjectNewWizard.PROJECT_NAME;
		}
